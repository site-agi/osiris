...
const SITE_NAME = "DOMINIQUE";
const SITE_TITLE = "DOMINIQUE — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | DOMINIQUE Intelligence",
  },
  ...
  openGraph: {
    title: "DOMINIQUE — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "DOMINIQUE — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ DOMINIQUE — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "DOMINIQUE",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "DOMINIQUE — OSINT Toolkit & Intelligence Platform",
  alternateName: ["DOMINIQUE", "OsirisAI", "Osiris OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="DOMINIQUE Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
